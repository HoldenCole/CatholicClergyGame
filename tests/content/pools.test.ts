...
describe('content pools', () => {
  ...
  it('every direction scene is sealed, and every sealed scene writes only what stays in the room', () => {
    ...
    expect(sealed.length).toBe(36); // 22 direction scenes, the two direction hours of the seminary's director (sp_for_), the seven hours a friar gives (dir_, E3 §3.13), and the five sealed hours of the confessor and director reputations (rp_, §8)
